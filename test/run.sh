...
echo "── unit: _ver_ge_030 (fzf change-header gate) ──"
assert_code "0.74.0 ok"   "0" "$(call _ver_ge_030 0.74.0; echo $?)"
assert_code "0.30.0 ok"   "0" "$(call _ver_ge_030 0.30.0; echo $?)"
assert_code "1.0.0 ok"    "0" "$(call _ver_ge_030 1.0.0; echo $?)"
assert_code "0.29.9 too old" "1" "$(call _ver_ge_030 0.29.9; echo $?)"
assert_code "empty -> no"    "1" "$(call _ver_ge_030 ''; echo $?)"
assert_code "garbage -> no"  "1" "$(call _ver_ge_030 'x.y'; echo $?)"
